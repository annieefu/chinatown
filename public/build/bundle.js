...
var app = (function () {
    ...
    // (160:6) {#each texts as paragraph, i}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "" + (/*types*/ ctx[4][/*i*/ ctx[9] + 1] + " fade-in" + " svelte-1nxm6mb"));
    			...
    			add_location(img, file, 161, 10, 12141);
    			attr_dev(div, "class", "img-container svelte-1nxm6mb");
    			add_location(div, file, 160, 8, 12103);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(160:6) {#each texts as paragraph, i}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(185:10) {#if types[i] == \\\"title\\\"}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(211:10) {#if types[i] == \\\"half2\\\"}",
    		ctx
    	});
    ...
    // (182:6) {#each texts as paragraph, i}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			attr_dev(div, "class", "" + (null_to_empty(/*steps*/ ctx[5][/*i*/ ctx[9]]) + " svelte-1nxm6mb"));
    			attr_dev(div, "id", /*i*/ ctx[9]);
    			toggle_class(div, "active", /*currentStep*/ ctx[0] === /*i*/ ctx[9]);
    			add_location(div, file, 182, 8, 12655);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(182:6) {#each texts as paragraph, i}",
    		ctx
    	});
    ...
    // (180:4) <Scrolly bind:value={currentStep}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 231, 156, 14076);
    			add_location(p, file, 231, 3, 13923);
    			add_location(br0, file, 231, 221, 14141);
    			add_location(br1, file, 231, 226, 14146);
    			add_location(br2, file, 231, 231, 14151);
    			add_location(br3, file, 231, 236, 14156);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				each_blocks[i].m(target, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(180:4) <Scrolly bind:value={currentStep}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div1 = element("div");
    			attr_dev(div0, "class", "image-div svelte-1nxm6mb");
    			add_location(div0, file, 157, 2, 12012);
    			add_location(div1, file, 236, 1, 14216);
    			attr_dev(div2, "class", "step-div svelte-1nxm6mb");
    			add_location(div2, file, 175, 2, 12485);
    			attr_dev(div3, "class", "desktop");
    			add_location(div3, file, 156, 0, 11988);
    			attr_dev(main, "class", "svelte-1nxm6mb");
    			add_location(main, file, 154, 0, 11980);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
